...
public class PizzaTonnoCipolla implements Pizza {
    ...
    public Set<Ingrediente> getListaIngredienti() {
        ...
        listaIngredienti.add(Ingrediente.CIPOLLA);
        listaIngredienti.add(Ingrediente.TONNO);
