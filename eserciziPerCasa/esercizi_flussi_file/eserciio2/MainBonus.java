...
public class MainBonus {
    public static void main(String[] args) {
        ...
        try{
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("eserciziPerCasa/esercizi_flussi_file/eserciio2/productBonus.txt"));
            for (Map.Entry<Integer, Product> mappa: mappaProdotti.entrySet()){
            ...
            BufferedReader bufferedReader = new BufferedReader(new FileReader("eserciziPerCasa/esercizi_flussi_file/eserciio2/productBonus.txt"));
